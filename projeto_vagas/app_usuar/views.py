...
from app_vagas.models import Candidato,Empresa,ESCOLARIDADE_CHOICES,FAIXA_SALARIAL_CHOICES
...
def cadastro(request):
    ...
    if request.method == "GET":
        ...
        if sobrenome is None:
            ...
            user = User.objects.create_user(username=username, email=email, first_name = nome, last_name = sobrenome, password= senha)
